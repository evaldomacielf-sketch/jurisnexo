...
export default function TeamPage() {
  // TODO: Integrate with team/users API when backend endpoint is available
  const currentUser = {
  ...
  const teamMembers: typeof currentUser[] = []; // Empty for now, will be fetched from API
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-full md:col-span-1 lg:col-span-2 bg-white dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Adicione advogados e assistentes para colaborar no escritório
            </p>
