...
export default function Error({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 text-center">
      <div className="bg-destructive/10 mb-8 flex h-20 w-20 items-center justify-center rounded-full text-destructive">
        <AlertCircle size={40} />
      </div>

      <h1 className="mb-2 text-4xl font-bold tracking-tight text-foreground">Algo deu errado!</h1>

      <p className="mb-8 max-w-md text-muted-foreground">
        Ocorreu um erro inesperado na aplicação. Nossa equipe foi notificada e estamos trabalhando
        para resolver.
      </p>
