  ...
  return (
    <div className="flex h-full flex-col bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {isTyping && (
          <div className="mt-2 animate-pulse text-sm italic text-gray-400">Digitando...</div>
        )}
      ...
      <div className="border-t border-gray-200 p-4 dark:border-gray-800">
        <MessageInput conversationId={conversationId} onTyping={() => emitTyping(conversationId)} />
      </div>
    </div>
  );
}
