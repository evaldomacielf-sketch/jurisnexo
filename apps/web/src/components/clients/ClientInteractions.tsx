  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {isAddingNote && (
          <div className="space-y-3 rounded-lg border border-blue-200 bg-blue-50/30 p-4 dark:border-blue-900/50 dark:bg-blue-900/10">
            <textarea
        ...
        {interactions && interactions.length > 0 ? (
          <div className="space-y-4">
            {interactions.map((interaction) => {
              ...
              const config =
                INTERACTION_TYPE_CONFIG[interaction.type] || INTERACTION_TYPE_CONFIG.other;
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0">
                    <div
                      className={`flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 ${config.color}`}
                    >
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    {(interaction.durationMinutes || interaction.outcome) && (
                      <div className="mt-2 flex gap-4 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        {interaction.outcome && <span>Resultado: {interaction.outcome}</span>}
                      </div>
                    )}
                  </div>
                </div>
