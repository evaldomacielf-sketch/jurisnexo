...
export default function LeadsDashboard() {
    ...
    const { data: leadsData, isLoading: leadsLoading } = useLeads({ ...filters, search: searchQuery || null });
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">
                            Gerencie e qualifique seus leads do WhatsApp
                        </p>
                    </div>
                    ...
                    <div className="flex gap-2">
                        {viewButtons.map((btn) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${view === btn.key
