...
export default function CRMAutoSyncSettings() {
    ...
    const updateSettings = useMutation({
        mutationFn: (data: CRMAutoSyncSettings) => api.put('/integrations/crm/settings/auto-sync', data),
        onSuccess: () => refetch()
    });
                ...
                <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div className="flex items-center gap-2">
                            <img src="/logos/salesforce.svg" alt="Salesforce" className="w-6 h-6" />
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <div className="flex items-center gap-2">
                            <img src="/logos/hubspot.svg" alt="HubSpot" className="w-6 h-6" />
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <div className="flex items-center gap-2">
                            <img src="/logos/pipedrive.svg" alt="Pipedrive" className="w-6 h-6" />
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <div className="flex items-center gap-2">
                            <img src="/logos/rdstation.svg" alt="RD Station" className="w-6 h-6" />
                ...
                <div className="space-y-3">
                    ...
                    <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Sincronizar quando o lead se tornar cliente
                            </p>
                        </div>
                        <input
                            type="checkbox"
