    ...
    <>
      ...
      >
        <TableCell className="py-3">
          <div
            className="row-padding flex cursor-pointer select-none items-center gap-2"
        ...
        <TableCell className="w-[100px] text-right text-sm text-gray-500">
