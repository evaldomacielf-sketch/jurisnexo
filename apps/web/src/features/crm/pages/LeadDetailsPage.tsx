    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Criado em {formatDate(lead.created_at)}</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <Badge className="px-3 py-1 text-base" style={{ backgroundColor: lead.stage.color }}>
              {lead.stage.name}
            </Badge>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-4">
          ...
          {lead.description && (
            <div className="border-t pt-4">
              <p className="mb-2 text-sm font-medium text-muted-foreground">Descrição</p>
