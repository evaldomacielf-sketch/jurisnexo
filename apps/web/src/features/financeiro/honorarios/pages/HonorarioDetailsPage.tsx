...
import { useHonorarioDetails, useRegistrarPagamentoHonorario } from '../hooks/useHonorarios';
...
export default function HonorarioDetailsPage() {
      ...
      <div className="p-6">
        <Card>
          <div className="py-12 text-center">
            ...
            <p className="mt-2 text-gray-500">O contrato solicitado não existe ou foi removido.</p>
            <button
  ...
  const currentStatus =
    statusConfig[honorario.status as keyof typeof statusConfig] || statusConfig.pendente;
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">ID: {honorario.id}</p>
          </div>
        </div>
        <div className={`flex items-center gap-2 rounded-full px-3 py-1.5 ${currentStatus.color}`}>
          {currentStatus.icon}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-green-600">
                {formatCurrency(honorario.valor_pago)}
              </p>
            </div>
          </div>
        </Card>
      ...
      <Card>
        ...
        <div className="h-3 w-full rounded-full bg-gray-200">
          <div className="progress-bar h-3 rounded-full bg-blue-600 transition-all duration-500"></div>
          <style jsx>{`
            .progress-bar {
              width: ${percentPago}%;
            }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-medium">
                  {honorario.cliente?.nome || 'Cliente não identificado'}
                </p>
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className="rounded-lg border p-4 text-center transition-colors hover:border-green-500 hover:bg-green-50"
                >
                ...
                <button
                  ...
                  disabled={gerarLink.isPending}
                  className="rounded-lg border p-4 text-center transition-colors hover:border-blue-500 hover:bg-blue-50"
                >
                  <span className="text-2xl">💳</span>
                ...
                <button
                  ...
                  disabled={gerarLink.isPending}
                  className="rounded-lg border p-4 text-center transition-colors hover:border-yellow-500 hover:bg-yellow-50"
                >
                  <span className="text-2xl">📄</span>
