                        ...
                        {activities.map((activity) => {
                            ...
                            return (
                                <div key={activity.id} className="relative">
                                    {/* Icon */}
                                    <div className="absolute -left-6 top-1 h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
                                    ...
                                    <div className="ml-4 p-4 rounded-lg border bg-card">
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="flex items-center gap-2">
                                                <Badge variant="secondary">{ACTIVITY_LABELS[activity.type] || activity.type}</Badge>
