                        ...
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 h-10 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50 focus:border-blue-500"
                                />
                            </div>
                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    <span className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 ${STATUS_CONFIG[caseItem.status]?.bgColor} ${STATUS_CONFIG[caseItem.status]?.color} border-transparent`}>
                                        ...
                                        {caseItem.tags && caseItem.tags.length > 0 && (
                                            <div className="flex flex-wrap gap-2">
                                                {caseItem.tags.map((tag) => (
                                                    <span key={tag} className="inline-flex items-center rounded-full border border-transparent bg-gray-100 px-2.5 py-0.5 text-xs font-semibold text-gray-900 hover:bg-gray-200/80 dark:bg-gray-800 dark:text-gray-50 dark:hover:bg-gray-800/80">
                                                        {tag}
                                                    </span>
                                                ))}
                                            </div>
