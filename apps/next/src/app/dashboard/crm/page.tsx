...
const MOCK_CONVERSATIONS = [
    {
        ...
        urgency: 'NORMAL',
        status: 'OPEN',
        last_message: { content: 'Olá, gostaria de saber sobre o processo', created_at: new Date().toISOString() },
    },
    {
        id: '2',
        ...
        urgency: 'HIGH',
        status: 'OPEN',
        last_message: { content: 'Preciso falar com advogado urgente sobre a audiência', created_at: new Date().toISOString() },
    },
    {
        id: '3',
        ...
        urgency: 'PLANTAO',
        status: 'OPEN',
        last_message: { content: 'SOCORRO URGENTE PRESO MANDADO', created_at: new Date().toISOString() },
    }
] as any[];
...
export default function CrmInboxPage() {
    ...
    useEffect(() => {
        ...
        const mockMsgs = [
            { id: 'm1', content: 'Olá, tudo bem?', direction: 'OUTBOUND', status: 'SENT', created_at: new Date(Date.now() - 10000).toISOString() },
            { id: 'm2', content: conversations.find(c => c.id === selectedId)?.last_message?.content || '...', direction: 'INBOUND', status: 'DELIVERED', created_at: new Date().toISOString() }
        ];
